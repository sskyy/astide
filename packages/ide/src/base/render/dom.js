...
function DefaultInvoke(fn, ...argv) {
  return fn(...argv)
}
...
export function createElement(node, isSVG, invoke = DefaultInvoke) {
...
export function updateElement(node, element, invoke = DefaultInvoke) {
  if (node.type === String) {
